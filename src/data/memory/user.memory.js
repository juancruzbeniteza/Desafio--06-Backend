    ...
    create(data){
      try {
        ...
        if (data.name && data.photo && data.email) {
            ...
            throw new Error(
              "Los campos name, photo y email son necesarios" 
            )
        }
      } catch (error) {
...
console.log(Manager.create({ photo: "https://img.freepik.com/foto-gratis/joven-confiado_1098-20868.jpg", email: "jcba@example.com"}));
Manager.create({name: "Tomas", photo: "https://img.freepik.com/foto-gratis/joven-confiado_1098-20868.jpg", email: "jcba@example.com"});
